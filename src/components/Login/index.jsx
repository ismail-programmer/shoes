      ...
      <div className='popup_login'>
        <div className='heading_login'>
          ...
          <i
            ...
            onClick={() =>
              (document.querySelector('#login').dataset.hidden = 'true')
            }
          ></i>
        </div>
        <div className='welcome_text'>Welcome to Albert Torresi</div>
        <div className='via'>Login via</div>
        <div className='blog_button_wrapper'>
          <button
            className='button facebook login_button'
            style={{ ['--color']: `#3b5998` }}
          >
            <i className='fab fa-facebook-f icon'></i>Facebook
          </button>
          <button
            className='button google login_button'
            style={{ ['--color']: `#DB4437` }}
          >
            <img
        ...
        <div className='otp'>Login usuing OTP</div>
        <div className='container'>
          <div className='form_wrapper'>
            <form action='/' className='form'>
              ...
              <button
                className='button right login_btn'
                style={{ ['--color']: `#000` }}
              >
                Login
              </button>
        ...
        <div className='new_section'>
          <div className='container new_section_wrapper'>
            ...
            <button className='button right' style={{ ['--color']: `#000` }}>
              Register
            </button>
          </div>
        </div>
